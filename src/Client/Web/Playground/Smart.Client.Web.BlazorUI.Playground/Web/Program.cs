...
public class Program
{
    ...
    public static WebApplication CreateHostBuilder(string[] args)
    {
        ...
        Smart.Client.Web.BlazorUI.Playground.Web.Startup.Services.Add(builder.Services, builder.Configuration);

        var app = builder.Build();

        Smart.Client.Web.BlazorUI.Playground.Web.Startup.Middlewares.Use(app, builder.Environment);
